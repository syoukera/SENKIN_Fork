...
C*****END SINGLE PRECISION
      PARAMETER ( LENIWK = 40000, LENRWK = 250000, LENCWK = 1000,
     1            LENSYM = 16)
      DIMENSION IWORK (LENIWK), IWORK_HOLD(LENIWK),
     1          RWORK (LENRWK), RWORK_HOLD (LENRWK)
      LOGICAL LEXIST, LEXIST_HOLD
      CHARACTER CWORK(LENCWK)*(LENSYM), CWORK_HOLD(LENCWK)*(LENSYM)
...
C
     ...
     2             RWORK_HOLD, IWORK_HOLD, COWRK_HOLD)
C
      STOP
      END
C
